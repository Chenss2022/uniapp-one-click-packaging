...
<template>
	<q-scroll-view layout='vbox' id="scrollView">
		<q-view layout='vbox' layout-spacing='5'>
			...
			<q-view :visible='isUniAppX' layout='hbox' >
				<q-view layout='hbox'>
					<q-view layout='vbox' layout-spacing='5'>
						<q-view layout='hbox' id="reportTypeView">
							<q-label text="平台:<span style='color: red;'> *</span>" id="labelView" :stretch-factor='1'></q-label>
							<q-checkbox id="HXCheckBox"  text="Android" :checked='phoneOsPlatform.includes(1)' data-value="1"  @clicked="setPlatform" :stretch-factor='1' style="margin-right: 10px;"/>
							<q-checkbox id="HXCheckBox"  text="iOS" :checked='phoneOsPlatform.includes(2)' data-value="2" @clicked="setPlatform" :stretch-factor='1' style="margin-right: 10px;"/>
							<q-checkbox id="HXCheckBox"  text="web" :checked='phoneOsPlatform.includes(3)' data-value="3" @clicked="setPlatform" :stretch-factor='1' style="margin-right: 10px;"/>
							<q-checkbox id="HXCheckBox"  text="微信小程序" :checked='phoneOsPlatform.includes(4)' data-value="4" @clicked="setPlatform" :stretch-factor='1' style="margin-right: 10px;"/>
							<q-checkbox id="HXCheckBox"  text="鸿蒙" :checked='phoneOsPlatform.includes(5)' data-value="5" @clicked="setPlatform" :stretch-factor='1'/>
							<q-view horizontal-size-policy="Expanding"></q-view>
						</q-view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getunixCheckedText(){
				if(!this.phoneOsPlatform  || this.phoneOsPlatform.length === 0 || this.phoneOsPlatform.length === 5) {
					return ''
				}
			...
			updatePhonePlatform(){
				...
				if(this.phoneOsPlatform.length === 1){
					if(this.phoneOsPlatform.includes(1) || this.phoneOsPlatform.includes(5)){
